...
pub async fn get_package(configuration: &configuration::Configuration, owner: &str, r#type: &str, name: &str, version: &str) -> Result<crate::models::Package, Error<GetPackageError>> {
    let local_var_configuration = configuration;
...
pub async fn list_package_files(configuration: &configuration::Configuration, owner: &str, r#type: &str, name: &str, version: &str) -> Result<Vec<crate::models::PackageFile>, Error<ListPackageFilesError>> {
    let local_var_configuration = configuration;
...
pub async fn list_packages(configuration: &configuration::Configuration, owner: &str, page: Option<i32>, limit: Option<i32>, r#type: Option<&str>, q: Option<&str>) -> Result<Vec<crate::models::Package>, Error<ListPackagesError>> {
    let local_var_configuration = configuration;
