...
pub async fn admin_create_hook(configuration: &configuration::Configuration, body: crate::models::CreateHookOption) -> Result<crate::models::Hook, Error<AdminCreateHookError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AdminCreateHookError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn admin_delete_hook(configuration: &configuration::Configuration, id: i64) -> Result<(), Error<AdminDeleteHookError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/amdin/hooks/{id}", local_var_configuration.base_path, id=id);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AdminDeleteHookError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn admin_delete_user(configuration: &configuration::Configuration, username: &str, purge: Option<bool>) -> Result<(), Error<AdminDeleteUserError>> {
    let local_var_configuration = configuration;
...
pub async fn admin_edit_hook(configuration: &configuration::Configuration, id: i64, body: Option<crate::models::EditHookOption>) -> Result<crate::models::Hook, Error<AdminEditHookError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/admin/hooks/{id}", local_var_configuration.base_path, id=id);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AdminEditHookError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn admin_get_hook(configuration: &configuration::Configuration, id: i64) -> Result<crate::models::Hook, Error<AdminGetHookError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AdminGetHookError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn admin_list_hooks(configuration: &configuration::Configuration, page: Option<i32>, limit: Option<i32>) -> Result<Vec<crate::models::Hook>, Error<AdminListHooksError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AdminListHooksError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
