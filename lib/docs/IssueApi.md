...
> crate::models::Attachment issue_create_issue_attachment(owner, repo, index, attachment, name)
...
> crate::models::Attachment issue_create_issue_comment_attachment(owner, repo, id, attachment, name)
...
> crate::models::Attachment issue_edit_issue_attachment(owner, repo, index, attachment_id, body)
...
> crate::models::Attachment issue_edit_issue_comment_attachment(owner, repo, id, attachment_id, body)
...
> crate::models::Attachment issue_get_issue_attachment(owner, repo, index, attachment_id)
...
> crate::models::Attachment issue_get_issue_comment_attachment(owner, repo, id, attachment_id)
...
> Vec<crate::models::Attachment> issue_list_issue_attachments(owner, repo, index)
...
> Vec<crate::models::Attachment> issue_list_issue_comment_attachments(owner, repo, id)
...
> Vec<crate::models::Issue> issue_list_issues(owner, repo, state, labels, q, r#type, milestones, since, before, created_by, assigned_by, mentioned_by, page, limit)
...
> Vec<crate::models::Issue> issue_search_issues(state, labels, milestones, q, priority_repo_id, r#type, since, before, assigned, created, mentioned, review_requested, owner, team, page, limit)
